...
class Project(models.Model):
    ...
    date_create = models.DateTimeField(null=True) 
    user_update = models.ForeignKey(User, on_delete=models.SET_NULL, blank=True, null=True, related_name='user_projects')
...
class Article(models.Model):
    ...
    user_update = models.ForeignKey(User, on_delete=models.SET_NULL, blank=True, null=True, related_name='user_articles')
    date_update = models.DateTimeField(null=True, blank=True)
